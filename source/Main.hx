	...
	**/
	public static var gameWeeks:Array<Dynamic> = [
		...
		[
			...
			['impostor', 'impostor', 'impostor2'],
			[FlxColor.RED],
			"Polus Problems"
		],
		[
			['Sussus-Toogus', 'Lights-Down', 'Reactor', 'Ejected'],
			['crewmate', 'impostor3', 'impostor3', 'parasite'],
			[FlxColor.fromRGB(0, 255, 0)],
			"Mira Mania"
		],
		[
			['Mando', 'Dlow', 'Oversight', 'Danger', 'Double-Kill'],
			['yellow', 'yellow', 'white', 'black', 'whiteblack'],
			[FlxColor.fromRGB(255, 218, 67),FlxColor.fromRGB(255, 218, 67),FlxColor.WHITE,FlxColor.fromRGB(179, 0, 255),FlxColor.fromRGB(179, 0, 255)],
			"Airship Atrocities"
		],
		[
			['Defeat'],
		...
		[
			['O2', 'Voting-Time', 'Turbulence', 'Victory'],
			['jorsawsee', 'votingtime', 'redmungus', 'warchief'],
			[FlxColor.fromRGB(38, 127, 230),FlxColor.fromRGB(153, 67, 196),FlxColor.RED,FlxColor.fromRGB(153, 67, 196)],
			"Jorsawsee's Jams"
		],
		[
			['ROOMCODE'],
		...
		[
			...
			['henry', 'charles', 'ellie', 'rhm'],
			[FlxColor.ORANGE,FlxColor.RED,FlxColor.ORANGE,FlxColor.ORANGE],
			"Battling the Boyfriend"
		],
		[
			['Sussy-Bussy', 'Rivals', 'Chewmate'],
			['tomongus', 'tomongus', 'hamster'],
		...
		[
			['Christmas', 'Spookpostor'],
			['fella', 'boo'],
			[FlxColor.fromRGB(0, 255, 0)],
			"Loggo's Halloween"
		],
		[
			['Alpha-Moogus', 'Actin-Sus'],
			['oldpostor', 'oldpostor'],
			[FlxColor.RED],
			"Vs. Impostor V1"
		],
		[
			['Ow', 'Who', 'Insane-Streamer', 'Sussus-Nuzzus', 'Idk', 'Esculent', 'Drippypop', 'Crewicide', 'Monotone-Attack', 'Top-10'],
			['kills', 'whoguys', 'jerma', 'nuzzles', 'idk', 'dead', 'drippy', 'dave', 'attack', 'top'],
			[FlxColor.fromRGB(84, 167, 202),FlxColor.fromRGB(22, 65, 240),FlxColor.BLACK,FlxColor.BLACK,FlxColor.fromRGB(255, 140, 177),FlxColor.BLACK,FlxColor.fromRGB(188, 106, 223),FlxColor.BLUE,FlxColor.WHITE,FlxColor.RED],
			""
		],
		[
			['Chippin', 'Chipping', 'Torture'],
			['cvp', 'cvp', 'ziffy'],
			[FlxColor.fromRGB(255, 60, 38),FlxColor.fromRGB(255, 60, 38),FlxColor.fromRGB(188, 106, 223)],
			""
		],
	];
